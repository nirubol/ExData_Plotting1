...
par(mfrow = c(2,2))
plot(dat$n.time,dat$gb_act, type = "l",ylab = "Global Active Power", xlab = "")
plot(dat$n.time,dat$voltage, type = "l",ylab = "Voltage", xlab = "datetime")
plot(dat$n.time,dat$sub1, type = "l", col = "black", ylab = "Energy sub metering", xlab = "")
points(dat$n.time,dat$sub2, type = "l", col = "red")
points(dat$n.time,dat$sub3, type = "l", col = "blue")
legend("topright", bty = "n", lty = 1, col = c("black","red","blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
plot(dat$n.time,dat$gb_react, type = "l",ylab = "Global_reactive_power", xlab = "datetime")
dev.off()